...
class ConnectionConfigControllerDeleteTest {
    ...
    @Test
    void shouldReturnUnauthorizedWhenTryingToDeleteWithoutCredentials() throws Exception {
    ...
    void shouldReturnForbiddenWhenTryingToDeleteWithWrongRole() throws Exception {
        ConnectionConfigDto configDto = TestHelper.getRandomConnectionConfigDto();
    ...
    void shouldDeleteConnectionConfig() throws Exception {
        ConnectionConfigDto configDto = TestHelper.getRandomConnectionConfigDto();
